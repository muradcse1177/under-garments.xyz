...
@section('title', 'Compare list || Under-Garments.Xyz Best Online Under Garments, Sex and Beauty Shop in Bangladesh')
@section('cart', 'active')
@section('css')
        ...
        <nav class="breadcrumb-nav">
            <div class="container">
                <ul class="breadcrumb shop-breadcrumb bb-no">
                    <li class="active"><a href="{{url('wishlist')}}">Compare</a></li>
                    ...
                    <div class="col-lg-8 pr-lg-4 mb-6">
                                ...
                                <tr>
                                    <td class="product-thumbnail">
                                        <div class="p-relative">
                                            ...
                                            <button type="submit" data-id="{{$product->product_id}}" class="btn btn-close compare_delete"><i
                        ...
                        @if($count>0)
                            <div class="cart-action mb-6">
                                ...
                                <button type="submit" class="btn btn-rounded btn-danger btn-clear-compare" name="clear_cart" value="Clear Cart">Clear Compare List</button>
                            </div>
                        @endif
                    </div>
                </div>
...
@section('js')
    <script>
            ...
            $.ajax({
                ...
                success: function(response){
                    if(!response.error){
                        $.toast({
                            heading: 'Thanks',
                            text: 'Compare List Cleared Successfully!!',
        ...
        $(document).on('click', '.compare_delete', function(e){
            e.preventDefault();
            var id = $(this).data('id');
            $.ajax({
                type: 'POST',
